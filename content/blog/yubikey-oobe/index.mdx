...
>
> https://support.yubico.com/hc/en-us/articles/4402836718866-Understanding-YubiKey-PINs即，在如下状态出现是否要将 key 储存在 cache 中时，无论是按  <kbd>y</kbd> 还是按 <kbd>n</kbd> 抑或是加上 <kbd>Enter</kbd> 都没有反应
>
> ```powershell
