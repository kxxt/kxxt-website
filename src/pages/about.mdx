...
Hello there, I am **kxxt** 👋, pursuing my master degree at **USTC (Hi-Tech Campus)**.

I major in **Cyberspace Security** at **the School of Cyber Science and Technologies**. I also always have a good passion for anything related to computers.
...
- **Arch Linux(Primary)**: I use Arch, BTW.
  - I use it for my daily work and it works perfectly.
- **Windows**: I don't have any Windows devices now.
